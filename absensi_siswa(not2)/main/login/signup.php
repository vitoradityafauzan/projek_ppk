...
<div class="form-group" style="width: 35%;">
	<label for="password2">Masukan Lagi Password</label>
...
<div class="form-group" style="width: 35%;">
	<label for="division">Jabatan</label>
	<input type="text" name="division" id="di1" class="bginput form-control" required>
</div>
<br>
<br>
<br>
